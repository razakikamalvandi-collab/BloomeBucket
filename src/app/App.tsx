...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-start py-0 sm:py-6">
      ...
      <div className="w-full sm:max-w-sm sm:rounded-[2.5rem] sm:overflow-hidden sm:shadow-2xl min-h-screen sm:min-h-0 sm:h-[812px] sm:overflow-y-auto bg-white relative">
        {mode === 'admin' && isAdmin ? (
